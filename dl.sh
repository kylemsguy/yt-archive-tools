...
yt-dlp --cookies-from-browser firefox --no-abort-on-error --sub-langs all --write-subs --embed-subs --add-metadata --write-description --write-thumbnail --embed-thumbnail --embed-metadata --write-info-json --match-filter !is_live --download-archive "shorts.txt" "https://www.youtube.com/@${channelname}/shorts" -o "shorts/$outputfilename"
yt-dlp --cookies-from-browser firefox --no-abort-on-error --sub-langs all --write-subs --embed-subs --add-metadata --write-description --write-thumbnail --embed-thumbnail --embed-metadata --write-info-json --match-filter !is_live --download-archive "videos.txt" "https://www.youtube.com/@${channelname}/videos" -o "videos/$outputfilename"
